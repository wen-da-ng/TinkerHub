# C:\Users\L\Desktop\Dev\MCP_learnings\mySecondAdvancedLLM\code_interpreter\generator.py
...
async def generate_analysis_code(provider: LLMProvider, data_sample: str, data_filepath: str, analysis_question: str) -> str:
    ...
    code_gen_prompt = (
        ...
        "6. If the file is JSON, it may contain paths to other files - use those exact paths\n"
    )
